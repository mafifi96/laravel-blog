    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/editor/post/store" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="slug" placeholder="slug"
                                required value="{{old('slug')}}">
                        </div>

                        <div class="form-group">
                            <input type="file" class="form-control form-control-user" name="cover" placeholder="Cover"
                                required>
                        </div>

                        <div class="form-group">
                            <textarea class="form-control form-control-user" name="excerpt" maxlength="150" required
                                placeholder="Excerpt...">{{old('excerpt')}}</textarea>
                        </div>
                        <div class="form-group">
                            <textarea id="postbody" class="form-control form-control-user body-content" name="body"
                                maxlength="500" required placeholder="Body...">
                                 {{old('body')}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="tags" placeholder="Tags"
